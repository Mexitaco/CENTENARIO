...
<head>
	...
	<script type="text/javascript">
		var arregloDT = <?php echo json_encode(Equipo::consHistEquipo($id)); ?>;
...
<main>
	...
	<section class="cta clearfix">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="cta-title"><strong>Historial de equipo </strong></h1>
                </div> <!-- /.col-md-12 -->
            </div> <!-- /.row -->
        </div> <!-- /.container -->
    </section> <!-- /.cta -->
	...
	<section class="light-content services">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="histEquipo-consulta">
						<div class="table-responsive">
							<table id="tablaHistEquipo" cellspacing="0" width="100%">
								<thead>
									<tr>
